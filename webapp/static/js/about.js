/* about.js — About overlay and social links */

const GITHUB_SVG = `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
  aria-hidden="true"><path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303
...
const LINKEDIN_SVG = `<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
  aria-hidden="true"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027
  -3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414
  v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455
  v6.286zM5.337 7.433a2.062 2.062 0 0 1-2.063-2.065 2.064 2.064 0 1 1
...
async function loadAboutContent() {
  ...
  if (aboutContentCache !== null) {
    body.innerHTML = aboutContentCache;
    return;
  }
  try {
    const res = await fetch("/content/about.md");
    const md = await res.text();
    aboutContentCache = marked.parse(md);
    body.innerHTML = aboutContentCache;
  } catch (err) {
